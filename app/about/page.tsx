      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center mb-16">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground md:text-xl">
              We believe that the future of publishing is digital, but that doesn't mean sacrificing quality or the joy
              of reading. Our magazines combine the best of traditional publishing with the convenience and
              interactivity of digital technology.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="rounded-lg border p-6">
              ...
              <p className="text-muted-foreground">
                We never compromise on quality. From the content we publish to the user experience we provide,
            ...
            <div className="rounded-lg border p-6">
              ...
              <p className="text-muted-foreground">
                We're constantly exploring new ways to enhance the digital reading experience and bring fresh ideas to
                our publications.
              </p>
            </div>
            <div className="rounded-lg border p-6">
              ...
              <p className="text-muted-foreground">
                We believe great content should be accessible to everyone. We strive to make our magazines available
