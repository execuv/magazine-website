                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-medium">
                      How do I access my purchased magazines?
                    </h4>
                    <p className="text-sm text-muted-foreground">
                      After purchase, you can download your magazines from your
                      account dashboard or access them via the email link we
                      send you.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium">
                      What devices can I read the magazines on?
                    </h4>
                    <p className="text-sm text-muted-foreground">
                      Our PDF magazines can be read on any device that supports
                      PDF viewing, including computers, tablets, e-readers, and
                      smartphones.
                    </p>
                  </div>
                  <div>
