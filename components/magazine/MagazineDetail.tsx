...
export default function MagazineDetail({ 
  ...
  const [selectedImage, setSelectedImage] = useState<string | null>(initialMagazine?.image || null)
  ...
  // Fetch magazine if not provided in props
  useEffect(() => {
    if (initialMagazine) return

    const fetchMagazine = async () => {
      try {
        const data = await getMagazineById(slug)
        if (!data) {
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
          ...
          <div className="space-y-6">
            {/* Rest of your UI code - product details, etc. */}
            <div>
